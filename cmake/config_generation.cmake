...
")
        if (tbb_gen_cfg_HANDLE_SUBDIRS)
            ...
            set(_libdir_for_pc_file "\${prefix}/lib/intel64/gcc4.8;\${prefix}/lib/")
            configure_file(${_tbb_gen_cfg_path}/../integration/pkg-config/tbb.pc.in ${config_install_dir}/tbb.pc @ONLY)

            set(_libdir_for_pc_file "\${prefix}/lib/ia32/gcc4.8;\${prefix}/lib32/")
...
")
            ...
            set(_libdir_for_pc_file "\${prefix}/lib/intel64/vc14;\${prefix}/lib/")
            configure_file(${_tbb_gen_cfg_path}/../integration/pkg-config/tbb.pc.in ${config_install_dir}/tbb.pc @ONLY)

            set(_libdir_for_pc_file "\${prefix}/lib/ia32/vc14;\${prefix}/lib32/")
            configure_file(${_tbb_gen_cfg_path}/../integration/pkg-config/tbb.pc.in ${config_install_dir}/tbb32.pc @ONLY)
        endif()
