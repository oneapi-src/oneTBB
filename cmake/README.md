...
TBB_FILE_TRIM:BOOL - Enable __FILE__ trim, replace a build-time full path with a relative path in the debug info and macro __FILE__, this can be used to make
