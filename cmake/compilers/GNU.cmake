...
if (MINGW)
    string(CONCAT TBB_COMMON_COMPILE_FLAGS ${TBB_COMMON_COMPILE_FLAGS} -U__STRICT_ANSI__)
    # set(TBB_COMMON_COMPILE_FLAGS "${TBB_COMMON_COMPILE_FLAGS} -U__STRICT_ANSI__) misbehaves
endif()
