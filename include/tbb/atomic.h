...
#error "TBB error: tbb/atomic.h is a legacy header which will be removed in a future release. For details, please see the Deprecated Features appendix in the TBB reference manual."
#endif
...
template<typename T>
tbb::internal::atomic<T> make_atomic(T t) {
    tbb::internal::atomic<T> a;
    tbb::internal::store<tbb::internal::relaxed>(a,t);
    return a;
}
} // interface6
...
using internal::memory_semantics;
using internal::full_fence;
using internal::acquire;
using internal::release;
using internal::relaxed;
using internal::atomic;
using internal::load;
