...
void alias_input_port(void *node, tbb::flow::interface11::receiver<InputType>* port, string_index name_index) {
...
void alias_output_port(void *node, tbb::flow::interface11::sender<OutputType>* port, string_index name_index) {
...
template<typename InputType>
void register_input_port(void *node, tbb::flow::interface11::receiver<InputType>* port, string_index name_index) {
...
template<typename OutputType>
void register_output_port(void* codeptr, void *node, tbb::flow::interface11::sender<OutputType>* port, string_index name_index) {
...
void fgt_multioutput_node_desc( const NodeType *node, const char *desc ) {
    void *addr =  (void *)( static_cast< tbb::flow::interface11::receiver< typename NodeType::input_type > * >(const_cast< NodeType *>(node)) );
...
static inline void fgt_node_desc( const NodeType *node, const char *desc ) {
    void *addr =  (void *)( static_cast< tbb::flow::interface11::sender< typename NodeType::output_type > * >(const_cast< NodeType *>(node)) );
    itt_metadata_str_add( ITT_DOMAIN_FLOW, addr, FLOW_NODE, FLOW_OBJECT_NAME, desc );
}
