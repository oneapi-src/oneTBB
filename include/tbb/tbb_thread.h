...
#if defined(__TBB_show_deprecated_header_message) && !defined(__TBB_LEGACY_MODE)
#error "TBB error: tbb/tbb_thread.h is a legacy header which will be removed in a future release. For details, please see the Deprecated Features appendix in the TBB reference manual."
#endif
...
namespace internal {
    ...
    // MSVC compiler doesn't respect friend declaration of tbb_hasher for unknown reason
    public:
#endif
    ...
    __TBB_DEPRECATED_VERBOSE_MSG("tbb::thread is deprecated, use std::thread") typedef tbb_thread_v3 tbb_thread;
} // namespace internal;

#if __TBB_LEGACY_MODE
using internal::tbb_thread;
#endif
...
inline void move( internal::tbb_thread_v3& t1, internal::tbb_thread_v3& t2 ) {
