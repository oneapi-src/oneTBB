...
TEST_CASE("limiter_node limiting"){
    ...
    oneapi::tbb::flow::limiter_node<input_msg> node1(g, 5);
    ...
    CHECK_MESSAGE( (conformance::get_values(node2).size() == 5), "Descendant of the node needs be receive limited number of messages");
}
