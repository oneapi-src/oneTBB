...
#include "../../src/tbb/string_view.h"

using tbb::detail::r1::string_view;
//TEST_CASE("Test creation") {
//
////    string_view sv{"test"}
//    REQUIRE_MESSAGE( string_view("test").size() == std::strlen("test"), "Wrong size of non empty string");
////    REQUIRE_MESSAGE( std::string(string_view("test").c_str()) == std::string("test"), "");
//}
