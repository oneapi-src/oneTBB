...
struct counter_printer {
    counter_printer() = default;
    counter_printer(const counter_printer&) {
        std::cout << "ctor copy count = " << copy_count << std::endl;
        ++copy_count;
    }

    counter_printer(counter_printer&&) {
        std::cout << "ctor move count = " << move_count << std::endl;
        ++move_count;
    }

    counter_printer& operator=(const counter_printer&) {
        std::cout << "assign copy count = " << copy_count << std::endl;
        ++copy_count;
        return *this;
    }

    counter_printer& operator=(counter_printer&&) {
        std::cout << "assign move count = " << move_count << std::endl;
        ++move_count;
        return *this;
    }
...
std::size_t counter_printer::copy_count = 0;
std::size_t counter_printer::move_count = 0;
...
TEST_CASE("123") {
    ...
    arena.execute([]() {
        ...
        using function_node_type = tbb::flow::function_node<counter_printer, counter_printer>;

        function_node_type f1(g, threshold, body);
        function_node_type f2(g, threshold, body);
        function_node_type f3(g, threshold, body);
