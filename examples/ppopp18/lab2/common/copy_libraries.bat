...
:: If it is not, try running Microsoft Visual Studio 2018 from Microsoft* Developer Command Prompt* for VS 2017.
...
exit /B 1
:error1
echo Could not determine path to Intel(R) Threading Building Blocks (Intel(R) TBB) libraries
exit /B 1
:error2
