...
struct hash {
  std::size_t operator()(const std::pair<const char*,const char*>& a) const {
    ...
    return ((a.first - *names_first) << M) | (a.second - *names_last);
  }
};
