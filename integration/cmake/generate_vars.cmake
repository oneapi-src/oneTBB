...
if (TBB_INSTALL_VARS)
    ...
    if (UNIX)
        ...
        set(LIBRARY_PATH_REPLACEMENT "$TBBROOT/lib/")
        set(CMAKE_ENVIRONMENT_SOURCING_STRING "CMAKE_PREFIX_PATH=\"\${TBBROOT}/lib/cmake/TBB:\${CMAKE_PREFIX_PATH}\"; export CMAKE_PREFIX_PATH")
    else()
        set(TBBROOT_REPLACEMENT "%~d0%~p0..")
        set(LIBRARY_PATH_REPLACEMENT "%TBBROOT%\\lib")
        set(BINARY_PATH_REPLACEMENT "%TBBROOT%\\bin")
        set(CMAKE_ENVIRONMENT_SOURCING_STRING "set \"CMAKE_PREFIX_PATH=%TBBROOT%\\lib\\cmake\\TBB;%CMAKE_PREFIX_PATH%\"")
    endif()
