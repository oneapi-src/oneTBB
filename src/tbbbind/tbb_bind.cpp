...
class platform_topology {
    ...
    platform_topology() : topology(nullptr),
                          process_cpu_affinity_mask(nullptr),
                          process_node_affinity_mask(nullptr),
                          numa_nodes_count(0),
...
void __TBB_internal_initialize_numa_topology( size_t groups_num, int& nodes_count, int*& indexes_list, int*& concurrency_list ) {
