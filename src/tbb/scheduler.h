...
struct scheduler_state {
    ...
    tbb::internal::atomic<bool>* my_current_is_recalled;
#endif
};
...
public:
    ...
    /** Together with my_nonlocal_ctx_list_update constitute synchronization protocol
        ...
        lock-free. **/
    tbb::internal::atomic<uintptr_t> my_local_ctx_list_update;
...
public:
    ...
    tbb::internal::atomic<uintptr_t> my_nonlocal_ctx_list_update;
#endif /* __TBB_TASK_GROUP_CONTEXT */
...
inline void generic_scheduler::do_post_resume_action() {
    ...
    case PRA_CLEANUP:
    {
        ...
        cleanup_worker(to_cleanup, !my_properties.master);
        governor::assume_scheduler(this);
        break;
    }
    case PRA_NOTIFY:
    {
        tbb::internal::atomic<bool>& scheduler_recall_flag = *static_cast<tbb::internal::atomic<bool>*>(my_post_resume_arg);
...
struct recall_functor {
    tbb::internal::atomic<bool>* scheduler_recall_flag;

    recall_functor(tbb::internal::atomic<bool>* recall_flag_) :
...
/* [[noreturn]] */ inline void co_local_wait_for_all(void* arg) {
    ...
    __TBB_ASSERT(s.my_wait_task == s.my_dummy_task, NULL);
    s.resume(*s.my_target_on_exit);
    __TBB_ASSERT(false, "Unreachable");
}
#endif /* __TBB_PREVIEW_RESUMABLE_TASKS */
