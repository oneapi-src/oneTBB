...
#include "../test/harness_barrier.h" // for Harness::atomic

Harness::atomic<long> FooCount;
...
#include "../test/harness_task_scheduler_init.h"
#include <math.h>
...
static void TestFindPrimes() {
    ...
    double t2 = TimeFindPrimes( Harness::task_scheduler_init::automatic );
