...
#if __TBB_CPF_BUILD && __TBB_LEGACY_MODE
...
#endif
{
    ...
    TestFuncDefinitionPresence( flow::make_edge, (tbb::flow::interface11::sender<Msg>&, tbb::flow::interface11::receiver<Msg>&), void );
    TestFuncDefinitionPresence( flow::remove_edge, (tbb::flow::interface11::sender<Msg>&, tbb::flow::interface11::receiver<Msg>&), void );
...
#if __TBB_CPP11_PRESENT && __TBB_LEGACY_MODE
