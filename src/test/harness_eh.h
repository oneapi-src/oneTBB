...
Harness::atomic<intptr_t> g_CurExecuted,
...
#if USE_TASK_SCHEDULER_OBSERVER
Harness::atomic<intptr_t> g_ActualMaxThreads;
Harness::atomic<intptr_t> g_ActualCurrentThreads;
#endif
...
Harness::atomic<intptr_t> g_NumExceptionsCaught;
...
#define UPDATE_COUNTS()     \
    ...
    typedef tbb::tbb_exception tbb_exception;
#else
     struct tbb_exception {
        char* name() {
