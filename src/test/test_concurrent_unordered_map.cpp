...
typedef tbb::concurrent_unordered_map<int, int, tbb::internal::tbb_hash<int>, std::equal_to<int>, MyAllocator> MyMap;
typedef tbb::concurrent_unordered_map<int, int, degenerate_hash<int>, std::equal_to<int>, MyAllocator> MyDegenerateMap;
typedef tbb::concurrent_unordered_map<int, check_type<int>, tbb::internal::tbb_hash<int>, std::equal_to<int>, MyAllocator> MyCheckedMap;
typedef tbb::concurrent_unordered_map<intptr_t, FooWithAssign, tbb::internal::tbb_hash<intptr_t>, std::equal_to<intptr_t>, MyAllocator> MyCheckedStateMap;
typedef tbb::concurrent_unordered_multimap<int, int, tbb::internal::tbb_hash<int>, std::equal_to<int>, MyAllocator> MyMultiMap;
typedef tbb::concurrent_unordered_multimap<int, int, degenerate_hash<int>, std::equal_to<int>, MyAllocator> MyDegenerateMultiMap;
typedef tbb::concurrent_unordered_multimap<int, check_type<int>, tbb::internal::tbb_hash<int>, std::equal_to<int>, MyAllocator> MyCheckedMultiMap;
...
struct cu_map_type : unordered_move_traits_base {
    ...
    struct apply {
        typedef tbb::concurrent_unordered_map<element_type, element_type, tbb::internal::tbb_hash<element_type>, std::equal_to<element_type>, allocator_type > type;
    };
...
struct cu_multimap_type : unordered_move_traits_base {
    template<typename element_type, typename allocator_type>
    struct apply {
        typedef tbb::concurrent_unordered_multimap<element_type, element_type, tbb::internal::tbb_hash<element_type>, std::equal_to<element_type>, allocator_type > type;
    };
...
struct UnorderedMapTypesTester{
    ...
    void check( const std::list<ValueType> &lst ) {
        ...
        TypeTester< defCtorPresent, tbb::concurrent_unordered_map< KeyType, ElemType, tbb::internal::tbb_hash<KeyType>, Harness::IsEqual>,
                                    tbb::concurrent_unordered_map< KeyType, ElemType, tbb::internal::tbb_hash<KeyType>, Harness::IsEqual, debug_allocator<ValueType> > >( lst );
        TypeTester< defCtorPresent, tbb::concurrent_unordered_multimap< KeyType, ElemType, tbb::internal::tbb_hash<KeyType>, Harness::IsEqual>,
                                    tbb::concurrent_unordered_multimap< KeyType, ElemType, tbb::internal::tbb_hash<KeyType>, Harness::IsEqual, debug_allocator<ValueType> > >( lst );
    }
};
...
void TestDeductionGuides() {
    ...
    static_assert(std::is_same<decltype(m5), TMap<int, std::string, tbb::internal::tbb_hash<int>,
    ...
    static_assert(std::is_same<decltype(m12), TMap<int, std::string, tbb::internal::tbb_hash<int>,
        std::equal_to<int>, std::allocator<int>>>::value);
