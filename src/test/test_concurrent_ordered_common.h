...
struct ordered_move_traits_base {
    ...
    static ordered_type& construct_container(tbb::internal::aligned_space<ordered_type> & storage, iterator_type begin, iterator_type end){
    ...
    static ordered_type& construct_container(tbb::internal::aligned_space<ordered_type> & storage, iterator_type begin, iterator_type end, allocator_type const& a ){
