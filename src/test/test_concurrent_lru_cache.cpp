...
namespace helpers{
    ...
    struct object_instances_counting_type{
        ...
        object_instances_counting_type(): m_p_count (new counter_type){*m_p_count =1; } //to overcome absence of constructor in Harness::atomic
    ...
    typedef object_instances_counting_type<Harness::atomic<std::size_t> > object_instances_counting_concurrent_type;
        ...
        namespace concurrent_tests{
            ...
            struct native_for_single_op_repeated_fixture{
                ...
                void run_native_for_and_assert_source_is_unique(native_for_concurrent_op::test_function_pointer_type operation,const char* msg){
                    ...
                    const size_t number_of_threads = min(4,Harness::task_scheduler_init::default_num_threads());
...
namespace concurrency_tests{
    ...
    TEST_CASE_WITH_FIXTURE(correctness_of_braces_and_handle_destructor,filled_instance_counting_fixture_with_external_array){
        ...
        static const size_t number_of_threads = 4 * Harness::task_scheduler_init::default_num_threads(); //have 4x over subscription
