...
static Harness::atomic<size_t> Order;
...
static Harness::atomic<int> barrier;
...
static Harness::atomic<int> n_waiters;
...
Harness::atomic<int> n_signaled;
Harness::atomic<int> n_done, n_done_1, n_done_2;
Harness::atomic<int> n_timed_out;
...
Harness::atomic<int> ticket_for_sleep, ticket_for_wakeup, signaled_ticket, wokeup_ticket;
Harness::atomic<unsigned> n_visit_to_waitq;
...
static Harness::atomic<int> err_count;
