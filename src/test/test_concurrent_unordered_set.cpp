...
typedef tbb::concurrent_unordered_set<int, tbb::internal::tbb_hash<int>, std::equal_to<int>, MyAllocator> MySet;
typedef tbb::concurrent_unordered_set<int, degenerate_hash<int>, std::equal_to<int>, MyAllocator> MyDegenerateSet;
typedef tbb::concurrent_unordered_set<check_type<int>, tbb::internal::tbb_hash<check_type<int> >, std::equal_to<check_type<int> >, MyAllocator> MyCheckedSet;
typedef tbb::concurrent_unordered_set<FooWithAssign, tbb::internal::tbb_hash<Foo>, std::equal_to<FooWithAssign>, MyAllocator> MyCheckedStateSet;
typedef tbb::concurrent_unordered_multiset<int, tbb::internal::tbb_hash<int>, std::equal_to<int>, MyAllocator> MyMultiSet;
typedef tbb::concurrent_unordered_multiset<int, degenerate_hash<int>, std::equal_to<int>, MyAllocator> MyDegenerateMultiSet;
typedef tbb::concurrent_unordered_multiset<check_type<int>, tbb::internal::tbb_hash<check_type<int> >, std::equal_to<check_type<int> >, MyAllocator> MyCheckedMultiSet;

#if __TBB_CPP11_RVALUE_REF_PRESENT
struct cu_set_type : unordered_move_traits_base {
    template<typename element_type, typename allocator_type>
    struct apply {
        typedef tbb::concurrent_unordered_set<element_type, tbb::internal::tbb_hash<element_type>, std::equal_to<element_type>, allocator_type > type;
    };
...
struct cu_multiset_type : unordered_move_traits_base {
    template<typename element_type, typename allocator_type>
    struct apply {
        typedef tbb::concurrent_unordered_multiset<element_type, tbb::internal::tbb_hash<element_type>, std::equal_to<element_type>, allocator_type > type;
    };
...
struct UnorderedSetTypesTester {
    ...
    void check( const std::list<value_type> &lst ) {
        TypeTester< defCtorPresent, tbb::concurrent_unordered_set<value_type, tbb::internal::tbb_hash<value_type>, Harness::IsEqual>,
            tbb::concurrent_unordered_set< value_type, tbb::internal::tbb_hash<value_type>, Harness::IsEqual, debug_allocator<value_type> > >( lst );
        TypeTester< defCtorPresent, tbb::concurrent_unordered_multiset<value_type, tbb::internal::tbb_hash<value_type>, Harness::IsEqual>,
            tbb::concurrent_unordered_multiset< value_type, tbb::internal::tbb_hash<value_type>, Harness::IsEqual, debug_allocator<value_type> > >( lst );
    }
};
...
void TestDeductionGuides() {
    ...
    static_assert(std::is_same<decltype(s5), TSet<ComplexType, tbb::internal::tbb_hash<ComplexType>,
    ...
    static_assert(std::is_same<decltype(s11), TSet<ComplexType, tbb::internal::tbb_hash<ComplexType>,
        std::equal_to<ComplexType>, std::allocator<ComplexType>>>::value);
