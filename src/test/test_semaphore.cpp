...
protected:
    ...
    Harness::atomic<unsigned>& myTokens;
    Harness::atomic<unsigned>& otherTokens;
    unsigned myWait;
    semaphore &mySem;
    semaphore &nextSem;
    unsigned* myBuffer;
...
public:
    FilterBase( FilterType ima_
            ,unsigned totTokens_
            ,Harness::atomic<unsigned>& myTokens_
            ,Harness::atomic<unsigned>& otherTokens_
            ,unsigned myWait_
            ,semaphore &mySem_
            ,semaphore &nextSem_
            ,unsigned* myBuffer_
...
void testProducerConsumer( unsigned totTokens, unsigned nTokens, unsigned pWait, unsigned cWait) {
    semaphore pSem;
    semaphore cSem;
    Harness::atomic<unsigned> pTokens;
    Harness::atomic<unsigned> cTokens;
    cTokens = 0;
