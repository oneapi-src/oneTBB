...
//! Abstraction from our internal atomic implementation
using tbb::internal::atomic;
using tbb::internal::full_fence;
using tbb::internal::acquire;
using tbb::internal::release;
using tbb::internal::relaxed;
...
{
    unsigned numThreads;
    atomic<unsigned> numThreadsFinished; // reached the barrier in this epoch
    // the number of times the barrier was opened; TODO: move to a separate cache line
    atomic<unsigned> epoch;
