...
struct fake_continue_sender : public tbb::flow::interface11::sender<tbb::flow::continue_msg>
{
    typedef tbb::flow::interface11::sender<tbb::flow::continue_msg>::successor_type successor_type;
    ...
    typedef tbb::flow::interface11::sender<tbb::flow::continue_msg>::built_successors_type built_successors_type;
...
struct parallel_puts : private NoAssign {
    ...
    tbb::flow::interface11::receiver< InputType > * const my_exe_node;

    parallel_puts( tbb::flow::interface11::receiver< InputType > &exe_node ) : my_exe_node(&exe_node) {}
...
Harness::atomic<size_t> global_execute_count;

template< typename OutputType >
struct inc_functor {

    Harness::atomic<size_t> local_execute_count;
...
struct lightweight_policy_body : NoAssign {
    const tbb::internal::tbb_thread::id my_thread_id;
    Harness::atomic<size_t> my_count;

    lightweight_policy_body() : my_thread_id(tbb::internal::thread_get_id_v3()) {
        my_count = 0;
    }
