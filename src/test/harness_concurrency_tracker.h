...
static atomic<unsigned> ctInstantParallelism;
static atomic<unsigned> ctPeakParallelism;
...
private:
    ...
    mutable atomic<size_t> myActiveBodyCnt;
    ...
    static tbb::spin_mutex global_mutex;
...
tbb::spin_mutex ExactConcurrencyLevel::global_mutex;
