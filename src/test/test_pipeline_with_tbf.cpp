...
//! Zero thread id
tbb::internal::tbb_thread::id id0;
...
class BaseFilter: public T {
    ...
    Harness::atomic<int> running_count;
public:
    Harness::atomic<tbb::internal::Token> current_token;
    ...
    void* operator()( void* item ) __TBB_override {
        ...
        if( is_serial_execution && !this->is_bound() ) {
            ...
            tbb::internal::tbb_thread::id id = tbb::internal::thread_get_id_v3();
...
struct hacked_pipeline {
    ...
    Harness::atomic<tbb::internal::Token> input_tokens;
    Harness::atomic<tbb::internal::Token> global_token_counter;
    bool end_of_input;
...
double PipelineTest::TestOneConfiguration(unsigned numeral, unsigned nthread, unsigned number_of_filters, tbb::internal::Token ntokens)
{
    ...
    tbb::internal::tbb_thread* t[MaxFilters];
    for( unsigned j = 0; j<number_of_tb_filters; j++)
        t[j] = new tbb::internal::tbb_thread(process_loop(), static_cast<tbb::thread_bound_filter*>(filter[array_of_tb_filter_numbers[j]]));
