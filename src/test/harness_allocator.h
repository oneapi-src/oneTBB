...
template <typename count_t = Harness::atomic<size_t> >
...
template <typename tag, typename count_t = Harness::atomic<size_t> >
...
template <typename tag, typename base_alloc_t, typename count_t = Harness::atomic<size_t> >
