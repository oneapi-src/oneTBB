...
static Harness::atomic<int> output_counter;
static Harness::atomic<int> input_counter;
static Harness::atomic<int> non_pointer_specialized_calls;
static Harness::atomic<int> pointer_specialized_calls;
static Harness::atomic<int> first_pointer_specialized_calls;
static Harness::atomic<int> second_pointer_specialized_calls;
