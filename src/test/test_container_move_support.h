...
Harness::atomic<size_t> FooCount;
...
struct default_container_traits{
    ...
    static container_type& construct_container(tbb::internal::aligned_space<container_type> & storage, iterator_type begin, iterator_type end){
    ...
    static container_type& construct_container(tbb::internal::aligned_space<container_type> & storage, iterator_type begin, iterator_type end, allocator_type const& a){
...
struct move_fixture : NoCopy{
    ...
    tbb::internal::aligned_space<container_t> source_storage;
    container_t & source;
...
struct arena_allocator_fixture : NoCopy{
    ...
    std::vector<tbb::internal::aligned_space<T, 1> > storage;
