...
struct ObserverStats {
    Harness::atomic<int> m_entries;
    Harness::atomic<int> m_exits;
    Harness::atomic<int> m_workerEntries;
    Harness::atomic<int> m_workerExits;
...
static Harness::atomic<int> theNumObservers;

const int P = min( Harness::task_scheduler_init::default_num_threads(), (int)sizeof(int) * CHAR_BIT );
...
public:
    ...
    void operator()( int i ) const {
        ...
        Harness::task_scheduler_init init(m_numThreads);
