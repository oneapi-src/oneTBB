...
static Harness::atomic<int> Counter1, Counter2;
static Harness::atomic<bool> Flag1, Flag2;
...
int TestMain () {
    ...
    int num_threads = tbb::internal::tbb_thread::hardware_concurrency();
