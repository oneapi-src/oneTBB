...
void BroadcastTest() {
    ...
    const int numNodes = 4 * Harness::task_scheduler_init::default_num_threads();
...
void ConcurrencyTest( const std::vector<opencl_device> &filteredDevices ) {
    const int numThreads = min( Harness::task_scheduler_init::default_num_threads(), 8 );
